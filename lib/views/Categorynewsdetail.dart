...
class Categorynewsdetail extends StatefulWidget {
  int index;
  List<Articles> arr;
  Categorynewsdetail({Key key, this.arr, this.index}) : super(key: key);

  @override
  State<Categorynewsdetail> createState() => _CategorynewsdetailState();
}
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
                        this.widget.arr[this.widget.index].title.toString(),
                        style: TextStyle(
                            fontSize: 24,
                            color: Colors.grey,
                            fontWeight: FontWeight.bold),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
                        this.widget.arr[this.widget.index].content.toString(),
                        style: TextStyle(
                            color: Colors.white, fontFamily: "Taviraj"),
                      ),
                    ),
                    Padding(
                      ...
                      child: Text(
                        "Published at ${this.widget.arr[this.widget.index].publishedAt.toString()}",
                        style: TextStyle(
                            color: Colors.white,
                            wordSpacing: 3,
                            fontWeight: FontWeight.bold,
