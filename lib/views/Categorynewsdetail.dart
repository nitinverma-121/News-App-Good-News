...
class Categorynewsdetail extends StatelessWidget {
  int index;
  List<Articles> arr;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    this.arr[this.index].title.toString(),
                    style: TextStyle(
                        fontSize: 24,
                        color: Colors.grey,
                        fontWeight: FontWeight.bold),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    this.arr[this.index].description.toString(),
                    style:
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                    this.arr[this.index].content.toString(),
                    style:
                        TextStyle(color: Colors.white, fontFamily: "Taviraj"),
                  ),
                ),
                Padding(
                  ...
                  child: Text(
                    "Published at ${this.arr[this.index].publishedAt.toString()}",
                    style: TextStyle(
                        color: Colors.white,
                        wordSpacing: 3,
                        fontWeight: FontWeight.bold,
